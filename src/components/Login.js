...
class Login extends Component {
    ...
    validateUser = () => {
        const isLogged = this.props.authenticateUser(this.state.email, this.state.password);
        console.log("ggggggggg"+this.props.authenticateUser(this.state.email, this.state.password));
        setTimeout(() => {
            if(this.props.auth.isLoggedIn && !isLogged === 'undefined') {
